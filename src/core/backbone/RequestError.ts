...
export class RequestError extends ApplicationError {
    ...
    public constructor(
        ...
        public readonly reason: string = "Platform operation failed unexpectedly.",
    ...
    public static fromAxiosError(
        ...
        try {
            ...
            if (!axiosError.response) {
                ...
                return new RequestError(method, path, platformParameters, code, reason, "", status).setObject(
            ...
            return new RequestError(
                ...
                platformParameters,
                "error.platform.unexpected",
                "An error occured while handling an axios error",
                requestId
            ).setObject(e)
        }
    }
